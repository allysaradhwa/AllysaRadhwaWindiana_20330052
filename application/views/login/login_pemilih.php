...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url()?>AdminLTE-2.4.3/index2.html"><b>Login Pemilih</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">

    <form action="<?= site_url('auth/login_pemilih_voting')?>" method="post">
      <div class="form-group has-feedback mb-3">
        <input name="Email1" type="email" class="form-control" placeholder="Email" required>
...
<!-- iCheck -->
<script src="<?= base_url()?>AdminLTE-2.4.3/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
